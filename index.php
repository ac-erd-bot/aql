...
$choices = getChoices('Monitored Hosts', 'shouldMonitor', '1') . getChoices('Revenue Impacting Hosts', 'revenueImpacting', '1') . getChoices('Backed-Up Hosts', 'shouldBackup', 'any') . getChoices('Decommissioned Hosts', 'decommissioned', '0');
